			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +56-18-27-82-34</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> contacto@electronic.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> 57300 Ubicación</a></li>
					</ul>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> + carito</button>
											</div>
										</div>
										<!-- /product -->
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Categoria</p>
										<h3 class="product-name"><a href="#">producto nombree</a></h3>
										<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Contacto <strong>Te esperamos</strong></p>
							<form>
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									...
									<li><a href="#">Ordens y productos</a></li>
